...
open-source/Ishmum.py

@MrIshmum

MrIshmum Add files via upload
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Ishmum-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/Ishmum-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/Ishmum-2F.txt', 'a').write(cid+' | '+ps+'\n')
